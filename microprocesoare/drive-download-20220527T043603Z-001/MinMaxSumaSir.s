.data
	...
	Prompt: .asciiz "Introduceti numarul de elemente n = "
	Prompt1: .asciiz "Introduceti elementul = "
	PrintfFormat1: .asciiz "Maximul este %d :\n"
	PrintfFormat2: .asciiz "Minimul este %d :\n"
	PrintfFormat3: .asciiz "Suma este %d :\n"
	PrintfMesaj_err: .asciiz "\nNumar negativ! Reluati!\n"
	...
	PrintfErr1: .word PrintfMesaj_err
...
main:
	...
	sle r15,r1,r0
	bnez r15, mesaj_err ; daca s-a tastat un numar negativ se afiseaza mesaj urmat de reluarea introducerii numarului de la tastatura
...
loop:
	...
	bnez r15, mesaj_err_el ; urmat de reluarea introducerii numarului de la tastatura

	slt r5,r1,r4 ; daca r1>r4 atunci minimul va deveni ultimul element citit
	beqz r5,maxim ; altfel se continua executia fireasca comparându-se elementul curent cu maximul din sir obtinut pâna în acest moment
	addi r4,r1,0 ; minimul devine ultimul element citit r4 ¬ r1
maxim:
	sgt r5,r1,r3 ; daca r1>r3 atunci maximul va deveni ultimul element citit
	beqz r5,suma ; altfel se continua executia fireasca calculându-se suma partiala a elementelor din sir citite pâna în acest moment
...
mesaj_err_el:
	sw PrintfValue3,r6 ; salvare parametrii afisare pentru un al doilea mesaj eroare
	addi r14,r0,PrintfErr1
